...
workflow TotalSegmentator {
 input {
   ...
   String totalSegmentatorDocker = "imagingdatacommons/download_convert_inference_totalseg_dicom_seg_pyradiomics_sr:v1.1.0"
...
task totalSegmentatorEndToEnd{
 ...
 command {
   wget https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.1.0/workflows/TotalSegmentator/Notebooks/endToEndTotalSegmentatorNotebook.ipynb
   set -e
