...
workflow TotalSegmentator {
 input {
   ...
   String downloadDicomAndConvertDocker = "imagingdatacommons/download_convert:v1.1.0"
   String inferenceTotalSegmentatorDocker = "imagingdatacommons/inference_totalseg:v1.1.0"
   String dicomsegAndRadiomicsSR_Docker = "imagingdatacommons/dicom_seg_pyradiomics_sr:v1.1.0"
...
task downloadAndConvert {
 ...
 command {
   wget https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.1.0/workflows/TotalSegmentator/Notebooks/downloadDicomAndConvertNotebook.ipynb
   set -e
...
task inferenceTotalSegmentator {
 ...
 command {
   wget https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.1.0/workflows/TotalSegmentator/Notebooks/inferenceTotalSegmentatorNotebook.ipynb
   set -e
...
task dicomsegAndRadiomicsSR{
 ...
 command {
   wget https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.1.0/workflows/TotalSegmentator/Notebooks/dicomsegAndRadiomicsSR_Notebook.ipynb
   set -e
