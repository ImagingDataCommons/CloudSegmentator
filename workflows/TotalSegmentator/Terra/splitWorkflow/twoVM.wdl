...
workflow TotalSegmentator {
 input {
   ...
   String downloadDicomAndConvertAndInferenceTotalSegmentatorDocker = "imagingdatacommons/download_convert_inference_totalseg:v1.3.1"
...
task downloadDicomAndConvertAndInferenceTotalSegmentator{
 ...
 command {
   wget https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.3.1/workflows/TotalSegmentator/Notebooks/downloadDicomAndConvertAndInferenceTotalSegmentatorNotebook.ipynb
   set -e
