...
workflow PerFrame {
 input {
   ...
   String docker_PerFrameFunctionalGroupsSequence = "imagingdatacommons/per_frame_functional_group_sequence:v1.2.0"
...
task PerFrameFunctionalGroupsSequence{
 ...
 command {
   wget https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.2.0/workflows/TotalSegmentator/Notebooks/postProcessingExtractPerframe.ipynb
