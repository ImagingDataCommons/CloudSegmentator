...
- id: downloadDicomAndConvertAndInferenceTotalSegmentator
  ...
  run:
    ...
    baseCommand:
    - wget
    - https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.3.1/workflows/TotalSegmentator/Notebooks/downloadDicomAndConvertAndInferenceTotalSegmentatorNotebook.ipynb
    - "&&"
    - set
    - "-e"
    - "&&"
    ...
    - class: DockerRequirement
      dockerPull: "imagingdatacommons/download_convert_inference_totalseg:v1.3.1"
