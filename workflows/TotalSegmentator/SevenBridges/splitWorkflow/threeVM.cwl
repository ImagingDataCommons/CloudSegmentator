...
- id: downloaddicomandconvert
  ...
  run:
    ...
    baseCommand:
    - wget
    - https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.2.0/workflows/TotalSegmentator/Notebooks/downloadDicomAndConvertNotebook.ipynb
    - "&&"
    - set
    - "-e"
    - "&&"
...
- id: inferencetotalsegmentator
  ...
  run:
    ...
    baseCommand:
    - wget
    - https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.2.0/workflows/TotalSegmentator/Notebooks/inferenceTotalSegmentatorNotebook.ipynb
    - "&&"
    - set
    - "-e"
    - "&&"
    ...
    - class: LoadListingRequirement
    - class: DockerRequirement
      dockerPull: "imagingdatacommons/inference_totalseg:v1.2.0"
    - class: InlineJavascriptRequirement
    hints:
    - class: sbg:AWSInstanceType
...
- id: dicomsegandradiomicssr
  ...
  run:
    ...
    baseCommand:
    - wget
    - https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.2.0/workflows/TotalSegmentator/Notebooks/dicomsegAndRadiomicsSR_Notebook.ipynb
    - "&&"
    - set
    - "-e"
    - "&&"
    ...
    - class: LoadListingRequirement
    - class: DockerRequirement
      dockerPull: "imagingdatacommons/dicom_seg_pyradiomics_sr:v1.2.0"
    - class: InlineJavascriptRequirement
    hints:
    - class: sbg:AWSInstanceType
