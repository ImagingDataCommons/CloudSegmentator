...
- id: totalsegmentatorend_to_end
  ...
  run:
    ...
    baseCommand:
    - wget
    - https://raw.githubusercontent.com/ImagingDataCommons/CloudSegmentator/v1.2.0/workflows/TotalSegmentator/Notebooks/endToEndTotalSegmentatorNotebook.ipynb
    - "&&"
    - set
    - "-e"
    - "&&"
    ...
    - class: DockerRequirement
      dockerPull: "imagingdatacommons/download_convert_inference_totalseg_dicom_seg_pyradiomics_sr:v1.2.0"
